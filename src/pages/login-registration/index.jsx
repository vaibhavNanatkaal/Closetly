            ...
            >
              ...
              >
                ...
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span className="font-medium">3 credits • 1GB storage</span>
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="bg-card/80 backdrop-blur-sm border border-border/50 rounded-2xl shadow-xl p-8">
                ...
                <p className="text-muted-foreground mb-6">Sign in with Google to continue</p>
                  ...
                  <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-3 mb-4">
                      ...
                      <button
                        type="button"
                        className="w-full inline-flex items-center justify-center whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-2 border-primary/20 bg-background/80 backdrop-blur-sm hover:border-primary/40 hover:bg-primary/5 hover:shadow-lg text-foreground h-11 px-6 py-2 rounded-xl"
                        onClick={() => {
